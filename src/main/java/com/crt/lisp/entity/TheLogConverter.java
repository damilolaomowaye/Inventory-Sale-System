...
public class TheLogConverter {
    ...
    public static UserLogEntity userLogConverter(User user){
        UserLogEntity userLog=new UserLogEntity();
        userLog.setCreatedDateTime(user.getCreatedDateTime());
        userLog.setCreatedUser(user.getCreatedUser());
        userLog.setLastModifiedDateTime(user.getLastModifiedDateTime());
        userLog.setLastModifiedUser(user.getLastModifiedUser());
        userLog.setUserAddress(user.getUserAddress());
        userLog.setUserContactNumber(user.getUserContactNumber());
        userLog.setUserEmail(user.getUserEmail());
        userLog.setUserFname(user.getUserFname());
        userLog.setUserLname(user.getUserLname());
        userLog.setUserId(user.getUserId());
        userLog.setUserName(user.getUserName());
        userLog.setVersion(user.getVersion());
        return userLog;
    }
